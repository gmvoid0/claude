...
your broker spent. `../5-SALES/12-aged-lead-playbook.md` and
`../5-SALES/13-dialer-and-numbers.md` are about extracting full value from an expensive lead.
...
`../5-SALES/10-script-book.md`; here is the principle.
