...
- **Refinancing resets you to the front of that curve.** A borrower ten years into a
  ...
  the argument behind the **swap-out close** (`../5-SALES/06-closing.md`) — offer a
  25-year instead.
...
(`../4-COMPLIANCE/03-trid-and-disclosures.md`).
...
Full treatment in `industry-2-follow-the-money.md`.
...
`industry-4-cast-of-characters.md`
...
**Next:** `industry-2-follow-the-money.md`
